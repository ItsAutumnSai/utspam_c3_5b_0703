...
class RentHistory {
  ...
  RentHistory copyWith({
    ...
    return RentHistory(
      ...
      isRentActive: isRentActive ?? this.isRentActive,
    );
  }
  ...
  factory RentHistory.fromMap(Map<String, dynamic> map) {
    return RentHistory(
      ...
      isRentActive: map['isRentActive'] as int,
    );
  }

  String toJson() => json.encode(toMap());

  factory RentHistory.fromJson(String source) =>
      RentHistory.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() {
    return 'RentHistory(id: $id, userId: $userId, carId: $carId, rentDate: $rentDate, rentDurationDays: $rentDurationDays, isRentActive: $isRentActive)';
  }
  ...
  bool operator ==(covariant RentHistory other) {
    ...
    return other.id == id &&
        ...
        other.isRentActive == isRentActive;
  }
